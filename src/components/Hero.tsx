			...
			<div className="container grid max-w-7xl grid-cols-1 items-center gap-12 px-4 md:grid-cols-2 md:px-6 z-10">
				<div className="space-y-4">
					...
					<h1 className="text-4xl font-bold">
						Sighted <span className="text-emerald-400">helps</span> you read
					</h1>
					<h1 className="text-4xl font-bold inline">
						<FlipWords words={words} />
					</h1>
					<p className="text-muted-foreground md:text-xl lg:text-base/relaxed">
						Revolutionize your reading with NLP and bionic AI algorithms. An
						exceptional solution for Dyslexia and ADHD book enthusiasts! 💪🧠
					</p>
					<div>
				...
				<div className="backdrop-blur-sm border border-slate-300 dark:border-zinc-800 rounded-md px-4 py-2 text-muted-foreground font-mono flex items-center gap-4">
					...
					<span>
						pip install <span className="dark:text-emerald-500">sighted</span>
					</span>
					<Button
						variant="ghost"
						size="icon"
